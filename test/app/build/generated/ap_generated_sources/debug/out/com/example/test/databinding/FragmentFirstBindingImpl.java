...
public class FragmentFirstBindingImpl extends FragmentFirstBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btLogin, 1);
        sViewsWithIds.put(R.id.btSignup, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.example.test.FirstFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.example.test.FirstFragment ViewModel) {
